...
class canSnifferGUI(QMainWindow, canSniffer_ui.Ui_MainWindow):
    def __init__(self):
        ...
        self.serialWriterThread = SerialWriter.SerialWriterThread(serial=self.serialController)
        self.serialReaderThread = SerialReader.SerialReaderThread(serial=self.serialController)
    ...
    def serialPortConnect(self):
        try:
            ...
            if self.activeChannelComboBox.currentIndex() < 3:
                self.serialController.baudrate = 500000
            elif self.activeChannelComboBox.currentIndex() == 3:
                self.serialController.baudrate = 38400
