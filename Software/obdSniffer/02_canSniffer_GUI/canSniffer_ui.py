...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.activeChannelComboBox.setItemText(3, _translate("MainWindow", "SCP"))
        ...
        item.setText(_translate("MainWindow", "ID/RR (hex)"))
        item = self.mainMessageTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "RTR/TT (hex)"))
        item = self.mainMessageTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "IDE/PP (hex)"))
