...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tempACButton = RoundButton(self.centralwidget, icon='pictures/AC.png')
        ...
        self.horizontalLayout_9.addWidget(self.tempACButton)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem4)
        self.verticalLayoutControls.addLayout(self.horizontalLayout_9)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.airFaceButton = RoundButton(self.centralwidget, icon='pictures/face.png')
        ...
        self.airFeetButton = RoundButton(self.centralwidget, icon='pictures/feet.png')
        ...
        self.airFeetFaceButton = RoundButton(self.centralwidget, icon='pictures/feet_face.png')
        ...
        self.airFeetFrontDefrostButton = RoundButton(self.centralwidget, icon='pictures/feetfront.png')
        ...
        self.airFrontDefrostButton = RoundButton(self.centralwidget, icon='pictures/front.png', icon_ratio=0.4)
        ...
        self.airRearDefrostButton = RoundButton(self.centralwidget, icon='pictures/rear.png', icon_ratio=0.4)
        ...
        self.airRecyclingButton = RoundButton(self.centralwidget, icon='pictures/recycle.png')
        ...
        self.onoffButton = RoundButton(self.centralwidget, icon='pictures/power.png', fill=True)
        ...
        self.verticalLayoutFan.addItem(spacerItem9)
